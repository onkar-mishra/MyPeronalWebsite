...
const WorkExp = () => {
  return (
    <div className="portfolio-container container my-5">
      <div className="row">
        <div className="col-12 col-md-6 col-lg-6 mb-4"> {/* First card */}
          <div className="cardd">
            <div className='company'>
              <h3><a href='https://bluesecures.com/'>Deskfactors</a></h3>
              <img src='../assets/company-images/bluesecures_logo.jpg' alt='Deskfactors Logo' />
            </div>
            <br />
        ...
        <div className="col-12 col-md-6 col-lg-6 mb-4"> {/* Second card */}
          <div className="cardd">
            <div className='company2'>
              <h3><a href='https://emudhra.com/'>eMudhra</a></h3>
              <img className='emudhra' src='../assets/company-images/emudhra.jpg' alt='eMudhra Logo' />
            </div>
            <br />
            <div className='comp-prof'>
        ...
        <div className="col-12 col-md-6 col-lg-6 offset-lg-3 mb-4"> {/* Centering third card */}
          <div className="cardd">
            <div className='company3'>
              <h3><a href='https://www.techactive.io/'>Tech Active Solutions</a></h3>
              <img className='emudhra' src='../assets/company-images/techactiveww_logo.jpg' alt='Tech Active Solutions Logo' />
            </div>
            <br />
            <div className='comp-prof'>
